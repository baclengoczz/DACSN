        ...
        NOLIST
;-------------------------------------------------------------------------
; $Id: p18F44K20.asm,v 1.2 2006/10/25 17:31:45 nairnj Exp $
; MPLAB-Cxx  PIC18F44K20 processor definition module
; 
; (c) Copyright 1999-2006 Microchip Technology, All rights reserved
;-------------------------------------------------------------------------

SFR_UNBANKED0       UDATA_ACS H'F77'

SSPMSK              
SSPMSKbits          RES 1     ; 0xF77
SLRCON              
SLRCONbits          RES 1     ; 0xF78
CM2CON1             
CM2CON1bits         RES 1     ; 0xF79
CM2CON0             
CM2CON0bits         RES 1     ; 0xF7A
CM1CON0             
CM1CON0bits         RES 1     ; 0xF7B
WPUB                
WPUBbits            RES 1     ; 0xF7C
IOCB                
IOCBbits            RES 1     ; 0xF7D
ANSEL               
