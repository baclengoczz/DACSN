...
static void CAN2510BitTimeInit( unsigned short long BitTimeConfig );      // only used by this function
...
static void CAN2510BitTimeInit( unsigned short long BitTimeConfig )
{
