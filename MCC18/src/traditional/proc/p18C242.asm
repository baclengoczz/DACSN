        ...
        NOLIST
;-------------------------------------------------------------------------
; $Id: p18C242.asm,v 1.2 2004/03/09 20:12:29 sealep Exp $
; MPLAB-Cxx  PIC18C242 processor definition module
; 
