        ...
        NOLIST
;-------------------------------------------------------------------------
; $Id: p18F6680.asm,v 1.2 2004/03/09 20:12:29 sealep Exp $
; MPLAB-Cxx  PIC18F6680 processor definition module
; 
