        ...
        NOLIST
;-------------------------------------------------------------------------
; $Id: p18F248.asm,v 1.2 2004/03/09 20:12:29 sealep Exp $
; MPLAB-Cxx  PIC18F248 processor definition module
; 
