        ...
        NOLIST
;-------------------------------------------------------------------------
; $Id: p18F6621.asm,v 1.3 2004/03/09 20:12:29 sealep Exp $
; MPLAB-Cxx  PIC18F6621 processor definition module
; 
; (c) Copyright 1999-2004 Microchip Technology, All rights reserved
;-------------------------------------------------------------------------

SFR_UNBANKED0       UDATA_ACS H'F67'

ECCP2DEL            
ECCP2DELbits        
PWM2CON             
PWM2CONbits         RES 1     ; 0xF67
ECCP2AS             
ECCP2ASbits         RES 1     ; 0xF68
ECCP3DEL            
ECCP3DELbits        
PWM3CON             
PWM3CONbits         RES 1     ; 0xF69
ECCP3AS             
...
ECCP1DELbits        
PWM1CON             
PWM1CONbits         RES 1     ; 0xF79
                    RES 2
BAUDCON2            
BAUDCON2bits        
BAUDCTL2            
BAUDCTL2bits        RES 1     ; 0xF7C
SPBRGH2             RES 1     ; 0xF7D
BAUDCON1            
BAUDCON1bits        
BAUDCTL1            
