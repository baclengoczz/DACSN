        ...
        NOLIST
;-------------------------------------------------------------------------
; $Id: p18F8490.asm,v 1.6 2005/08/18 21:40:42 nairnj Exp $
; MPLAB-Cxx  PIC18F8490 processor definition module
; 
...
LCDSE4              
LCDSE4bits          RES 1     ; 0xF5E
LCDSE5              
LCDSE5bits          RES 1     ; 0xF5F
