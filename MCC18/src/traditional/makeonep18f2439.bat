...
if "%1"=="18f2439" goto X439
if "%1"=="18f4439" goto X439
goto NEXT
:X439
mpasm /rDEC /l- /o /q /d__LARGE__ /p18CXX PRMTX439.asm
mplib /q /r ..\..\p%1.lib PRMTX439.O
goto DONE 
:NEXT 
if "%1"=="18f2539" goto X539
if "%1"=="18f4539" goto X539
goto DONE 
:X539
mpasm /rDEC /l- /o /q /d__LARGE__ /p18CXX PRMTX539.asm
mplib /q /r ..\..\p%1.lib PRMTX539.O
:DONE
