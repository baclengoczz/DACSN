...
if "%1"=="18f248" goto skip1
if "%1"=="18f258" goto skip1
for %%i in (ep*.c) do mcc18 -ls --no-extended -ml -p=%1 %%i
:skip1
for %%i in (*.o) do mplib /q /r ..\..\p%1.lib %%i
...
if "%1"=="18f248" goto skip2
if "%1"=="18f258" goto skip2
mcc18 -ls --no-extended -ml -p=%1 ew1open.c 
mcc18 -ls --no-extended -ml -p=%1 ew1setdc.c 
mcc18 -ls --no-extended -ml -p=%1 ew1setoc.c 
mcc18 -ls --no-extended -ml -p=%1 ew1close.c 
:skip2
for %%i in (*.o) do mplib /q /r ..\..\p%1.lib %%i
...
for %%i in (*.asm) do mpasm /rDEC /l- /o /q /d__LARGE__ /p%1 %%i
for %%f in (*.ERR) do type %%f
for %%i in (rb0*.c) do mcc18 -ls --no-extended -ml -p=%1 %%i
for %%i in (rb1*.c) do mcc18 -ls --no-extended -ml -p=%1 %%i
for %%i in (pb*.c) do mcc18 -ls --no-extended -ml -p=%1 %%i
for %%i in (pull*.c) do mcc18 -ls --no-extended -ml -p=%1 %%i
for %%i in (*.o) do mplib /q /r ..\..\p%1.lib %%i
