...
echo ...I2C module not currently supported for this family...
...
echo ...SPI module not currently supported for this family...
...
echo ...timers module...
echo NOTE: timer5 not currently supported
cd Timers
for %%f in (*.o) do del %%f
for %%f in (*.err) do del %%f
for %%f in (*.lst) do del %%f
