/*-------------------------------------------------------------------------
 * $Id: p18f8520.h,v 1.10 2005/12/19 16:40:18 nairnj Exp $
 * MPLAB-Cxx  PIC18F8520 processor header
 *
...
#define _MODE_EM_3L          0xFC
#define _MODE_MPB_3L         0xFD
#define _MODE_MP_3L          0xFE
#define _MODE_MC_3L          0xFF

#define _WAIT_ON_3L          0x7F
#define _WAIT_OFF_3L         0xFF

/*-------------------------------------------------------------------------
 *   CONFIG3H (0x300005)
 *-------------------------------------------------------------------------*/
#define _CONFIG3H_DEFAULT    0x03
#define _CCP2MUX_OFF_3H      0xFE
#define _CCP2MUX_RE7_3H      0xFE
