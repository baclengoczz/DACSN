/*-------------------------------------------------------------------------
 * $Id: p18f4431.h,v 1.8 2004/09/28 22:35:48 curtiss Exp $
 * MPLAB-Cxx  PIC18F4431 processor header
 *
...
extern volatile near unsigned char       PDC3H;
extern volatile near unsigned char       PDC3L;
...
extern volatile near unsigned char       ANSEL1;
extern volatile near struct {
  unsigned ANS8:1;
} ANSEL1bits;
...
#define _OSC_RC1_1H          0xFB
#define _OSC_RC_1H           0xFF
...
#define _EXCLKMX_RD0_3H      0xEF
#define _EXCLKMX_RC3_3H      0xFF

#define _PWM4MX_RD5_3H       0xF7
#define _PWM4MX_RB5_3H       0xFF

#define _SSPMX_RD1_3H        0xFB
#define _SSPMX_RC7_3H        0xFF

#define _FLTAMX_RD4_3H       0xFE
#define _FLTAMX_RC1_3H       0xFF
